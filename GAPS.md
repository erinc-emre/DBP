...
| Chase camera | ✅ | Baked follow cam (`ChaseCam`); `Camera_T3` = overview. Held **parallel to the Earth's surface** (optical axis = horizontal travel tangent, up = radial): zero pitch & roll vs. the ground at every frame |
