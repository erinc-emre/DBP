...
| Chase camera | ✅ | Baked follow cam (`ChaseCam`); `Camera_T3` = overview. Horizon **leveled to the Earth** (up = radial), not world-Z, so it doesn't roll as the plane crosses the globe |
